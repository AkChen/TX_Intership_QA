...
- 一般入职流程是什么？  
收到实习录用函->手写签字或者pdf签字(WPS功能)确认->HR回复收到->收到入职指引->办理银行卡，工卡照等准备-->进入入职指引邮件里的地址上传相关信息->审核通过->等待入职->入职办理->拿到token->入职单
->配置环境、入职

- 回复入职录用函一般HR会回复?  
一般在一个工作日会恢复“同学您好，已收到”
...
- 如何修改入职日期？  
可以通过Q星鹅（微信公众号）修改入职日期，但是最好提前一段时间修改且不要频繁修改，需要审核。审核通过后会邮件通知并第二个工作日同步到Q星鹅

- 请问入职信息填完后多少天审核通过？  
和填写的入职时间有关系，一般情况下入职时间越靠前越先审核通过。  

- 审核通过后该干嘛？  
静心等待入职邮件通知即可，通常在填写的入职时间前几天。
...
- 如何看所在部门？ 
在入职信息审核通过后的 hr-onboarding 邮件里会有。
...
- 工卡照要求  
<img src="https://s1.ax1x.com/2020/04/16/JF0cRS.png" alt="JF0cRS.png" height="300" border="0" />
